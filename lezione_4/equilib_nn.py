...
if not os.path.exists("IA_equilib"):
    os.mkdir("IA_equilib")
...
with open('./IA_equilib/norm.csv', 'w', newline='') as csv_file:
...
np.save("IA_equilib/train_loss_epochs.npy", loss_train_epochs)
np.save("IA_equilib/val_loss_epochs.npy", loss_val_epochs)
...
plt.ylabel('MSE Loss')
plt.title('Losses')
fig.savefig("IA_equilib/loss.png")
